...
func ApplyThinkingInjection(store ConfigReader, stdReq promptcompat.StandardRequest) promptcompat.StandardRequest {
	...
	finalPrompt, toolNames := promptcompat.BuildOpenAIPromptWithPrepareOptions(messages, stdReq.ToolsRaw, "", stdReq.ToolChoice, stdReq.Thinking, stdReq.PrepareOptionsOrDefault())
